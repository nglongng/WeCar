        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<int>(type: "int", nullable: false),
                    FuelId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bills_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BillsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ServicesId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillService", x => new { x.BillsId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_BillService_Bills_BillsId",
                        column: x => x.BillsId,
                        principalTable: "Bills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BillService_Services_ServicesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bills_ScheduleId",
                table: "Bills",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_BillService_ServicesId",
                table: "BillService",
                column: "ServicesId");
